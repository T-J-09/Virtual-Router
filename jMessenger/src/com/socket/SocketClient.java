    ...
    public void run() {
        ...
        while(keepRunning){
            try {
                ...
                }else if (msg.type.equals("shutdown")) {
                    System.out.println("Shoutdown msg"+msg.content);
                    String receivedmsg = msg.content;
                    String ip = InetAddress.getLocalHost().getHostAddress();
                    if (receivedmsg.equals(ip)) {
                        String comment = "Shutdown command received from. System will shutdown in 10sec";
                         ui.jTextArea1.append("["+msg.sender +" > Me] : " + comment + "\n");
                         Runtime.getRuntime().exec("shutdown -m \\\\"+ip+" -s -t 10");
                    }
                }
