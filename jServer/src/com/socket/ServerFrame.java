...
public class ServerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Shutdown Remote Computer");

        jLabel2.setText("Enter remote computer IP:");
        ...
        try {
            ...
            String ip=jTextField1.getText();  
               if (ip.equals("") || ip.equals(null)) {
                   JOptionPane.showMessageDialog(null, "Enter Remote PC IP Address");
            }else{
                    Message msg = new Message("shutdown", "SERVER", ip, "All");          
                ServerThread clients[] = server.clients;
